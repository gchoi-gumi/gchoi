...
export function WeatherTestPage() {
  ...
  const runTests = async () => {
    ...
    try {
      const url = `https://${projectId}.supabase.co/functions/v1/make-server-a8dd3f70/weather/서울`;
    ...
    try {
      const url = `https://${projectId}.supabase.co/functions/v1/make-server-a8dd3f70/weather/Seoul`;
        ...
        <div className="bg-white rounded-t-3xl shadow-lg p-6 mb-4">
          ...
          <Card className="p-4 bg-blue-50 border-blue-200 mb-6">
            ...
            <div className="text-xs space-y-1 text-gray-700">
              ...
              <p>API URL: https://{projectId}.supabase.co/functions/v1/make-server-a8dd3f70</p>
            </div>
          </Card>
