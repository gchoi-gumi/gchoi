...
export function BottomNav({ currentPage, onNavigate }: BottomNavProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 md:max-w-7xl md:mx-auto bg-white/95 backdrop-blur-xl border-t border-gray-100 shadow-[0_-4px_24px_rgba(0,0,0,0.04)] z-50">
      <div className="flex items-center justify-around px-4 py-2 safe-area-inset-bottom max-w-full">
        {navItems.map((item) => {
